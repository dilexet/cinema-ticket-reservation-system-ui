...
import SessionSeatTypeChange from "./SessionSeatTypeChange";

const CollapsibleSessionSeatTypeTableChange = ({
                                                   openRows,
                                                   errors,
                                                   touched,
                                                   handleChange,
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12}>
                                <Table width='auto' size="small" aria-label="purchases">
                                    ...
                                    <TableBody>
                                        {
                                            values.sessionSeatTypes ?
                                                values.sessionSeatTypes.map((seatType, index) => (
                                                    <React.Fragment key={index}>
                                                        <SessionSeatTypeChange
...
export default CollapsibleSessionSeatTypeTableChange;